        ...
        <form class="modal-box max-w-sm" wire:submit.prevent="login">
            ...
            <div class="py-4 space-y-2">
                <div class="form-control">
                    <input type="text" class="input @error('username') input-error @enderror bg-base-200"
                ...
                <div class="form-control">
                    <input type="password" class="input @error('password') input-error @enderror bg-base-200"
