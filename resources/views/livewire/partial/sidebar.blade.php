<ul class="menu p-4 w-80 min-h-full bg-base-100 text-base-content space-y-4" wire:poll>
    <li>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('order.queue') }}" wire:navigate>
            ...
            <li>
                <a href="{{ route('order.progress') }}" wire:navigate>
            ...
            <li>
                <a href="{{ route('order.done') }}" wire:navigate>
